...
describe 'curation_concerns/base/relationships', type: :view do
  ...
  let(:collection) { double(id: '345', title: ['Containing collection', 'foobar'], to_s: 'Containing collection', model_name: Collection.model_name.param_key) }
  let(:generic_work) { double(id: '456', title: ['Containing work', 'barbaz'], to_s: 'Containing work', model_name: GenericWork.model_name.param_key) }
